...
export type ModulusNodeProps = NodeProps & { data: ModulusNodeData };

/**
 * Modulus (remainder) node that computes the remainder after division.
    ...
    return (
        <NodeTemplate
            details={{
                ...
                icon: mode === "expression" && !isValid ? AlertTriangle : Percent,
                name: "Modulus",
                description:
                    mode === "linear"
